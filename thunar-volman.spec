...
Source0  : http://archive.xfce.org/src/xfce/thunar-volman/4.15/thunar-volman-4.15.1.tar.bz2
...
%prep
%setup -q -n thunar-volman-4.15.1
cd %{_builddir}/thunar-volman-4.15.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604522243
...
cp %{_builddir}/thunar-volman-4.15.1/COPYING %{buildroot}/usr/share/package-licenses/thunar-volman/dfac199a7539a404407098a2541b9482279f690d
%make_install
